...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.php"> <img src="img/CleaningLogo-min.png" alt="Cleaning JP"
                style="height: 35px; object-fit: contain;"> </a>
            ...
            <?php if (isLoggedIn()): ?>
                <ul class="navbar-nav me-auto">
                    <?php if (isAdmin()): ?>
                        ...
                        <li class="nav-item"><a class="nav-link" href="job_form_admin.php">Add a Jobs</a></li>
